<{* +++++++++++++++++ START HEAD ++++++++++++++++++++++ *}>
<{include file='common/module_head.tpl' title=$smarty.const.NEWS creat_title=$smarty.const.ADMIN_CREATING_NEW_NEWS edit_title=$smarty.const.ADMIN_EDIT_NEWS}>
...
<script type="text/javascript">
    function formCheck(form){
        ...
        if (form.created.value.length == 0) {
           alert('Укажите дату создания статьи!');
           return false;
        } return true;
    }
</script>
            ...
            <ul class="tabs">
                <li class="active" id="tab_main">
                    <table border="1" cellspacing="0" cellpadding="1" class="sheet">
                        ...
                        <tr>
                            <td id="headb" align="left"><{$smarty.const.HEAD_DATE}> <font style="color:red">*</font></td>
                            <td align="left">
                                <input class="datepicker" name="created" size="9" id="created" type="text" value="<{$item.created|date_format:"%d.%m.%Y"}>"/>
                            </td>
                            <td class="buttons_row"></td>
                        </tr>
