...
<tr>
    ...
    <td> 
        ...
        <table style="margin-bottom:5px;" width="100%" border="0" cellspacing="0" cellpadding="0" class="sheet" id="toogleFileBox">
            <tr>
                <td width="85%">
...
<tr>
    <td id="headb" align="left"><{$smarty.const.HEAD_ATTACH_FILE}></td>
    <td> 
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="list colored" id="toogleFileBox">
            <tr>
