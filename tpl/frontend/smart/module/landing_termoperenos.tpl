...
<div class="top-banner landing termoperenos">
    <div class="container">
        ...
        <h1 class="heading">Термоперенос на одежде <br>и аксессуарах</h1>
...
<div class="technology-print" id="technology">
    <div class="inner middle-container container">
        <div class="signature">
            <h2>
                <span>Термоперенос</span> (Термопечать)
            </h2>
            <p>
                Технология нанесения изображения высокого качества на ткань или 
                одежду с количеством цветов до 4 штук. Используется для нанесения 
                рисунков, принтов, фото, надписей на текстильные изделия с помощью
                термопленки и термопресса.
            </p>
        </div>
        <div class="technology-print-wrapper">
            <div class="print-method">
                <img src="/images/tmp/landings/termoperenos/1.jpg" alt="">
                <div>
                    <h3>Яркие цвета в термопечати</h3>
                    <p>
                        Все возможные цвета для вашего принта! Для людей с радужной душой 
                        мы подготовили 1000 различных красок: объемные, матовые, бархатные,
                        глянцевые и зеркальные пленки помогут сделать изображение на вашей 
                        одежде - эксклюзивным.
                    </p>
                </div>
            </div>
            <div class="print-method">
                <img src="/images/tmp/landings/termoperenos/2.jpg" alt="">
                <div>
                    <h3>Термоперенос изображения на одежду за 15 минут!</h3>
                    <p>
                        Пришлите свой эскиз и мы с легкостью напечатаем его на 
                        выбранное изделие. Любой желаемый рисунок может оказаться
                        на одежде всего за четверть часа.
                    </p>
                </div>
            </div>
            <div class="print-method">
                <img src="/images/tmp/landings/termoperenos/3.jpg" alt="">
                <div>
                    <h3>Термотрансфер оптом и в розницу</h3>
                    <p>
                        Применяя термотрансфер, можно нанести как 1-о индивидуальное 
                        изображение в розницу, так и однотипный логотип оптом до 1000 штук. 
                        Метод идеально подойдёт для печати на одежде и аксессуарах: 
                        логотипа компании, торговой марки, надписи или лозунга.
                    </p>
                </div>
            </div>
            <div class="print-method">
                <img src="/images/tmp/landings/termoperenos/4.jpg" alt="">
                <div>
                    <h3>Гарантия на износостойкость напечатанного принта</h3>
                    <p>
                        Все изображения нанесенные термопереносом выдерживают до 
                        50-и машинных стирок не теряя цвета и внешнего вида. 
                        Печать производится исключительно на фирменных изделиях
                        хорошего качества, что гарантирует отличную износостойкость.
                    </p>
                </div>
            </div>
        </div>
...
<{*<div class="price-table" id="price-table">
    <div class="inner middle-container container">
        <div class="signature">
            <h2>
                <span>Цены</span> на термоперенос</h2>
        ...
        <div class="price-table-wrapper">
            <table>
                <thead>
                    <tr>
                        <th colspan="5">Термоперенос флекс от 1 шт</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="5">
                            <p>Цены указаны на печать термопереносом на одной футболке 
                                без учета стоимости самой футболки в грн.
                            </p>
                            <p>
                            ...
                            <p>
                                Печать флексом на зонтах, сумках, чехлах, куртках +20-50% к стоимости.
                                Сложные макеты +20-50% к стоимости.
                            </p>
                        </td>
                    </tr>
                </tfoot>
    ...
    <div class="brand-swiper-element">
        ...
        <div class="swiper-container brand-wrapper swiper-container-horizontal swiper-container-free-mode">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/1.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/2.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/3.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/4.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/5.jpg" alt="">
                    </div>
                </div>
                
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/6.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/7.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/8.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/9.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/10.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/11.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/termoperenos/brand-slider/12.jpg" alt="">
                    </div>
                </div>
            </div>
