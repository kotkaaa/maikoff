...
<div class="top-banner landing cups black">
    <div class="container">
        <div class="anchor-links">
            <ul>
                <li>
                    <a href="#t-shirt">Чашки</a>
                </li>
                <li>
        ...
        <h1 class="heading">Печать на чашках <br>логотипа и надписи</h1>
...
<div class="section-features">
    <div class="container">
        ...
        <div class="features express">
            ...
            <div class="features-item">
                <div class="features-info icon"></div>
                <h4>Заказы от 10 шт</h4>
                <p class="text-info">
                    Печать от 10 шт возможна методом сублимация
                </p>
            </div>
            <div class="features-item">
                <div class="features-info icon"></div>
                ...
                <p class="text-info">
                    Нанесение всеми видами печати: сублимация, деколь и шелкотрафарет
                </p>
            </div>
            <div class="features-item">
                <div class="features-info icon"></div>
                ...
                <p class="text-info">
                    Бесплатная доставка изделий с нанесением по Киеву от 10 шт
                </p>
            </div>
        </div>
    </div>
...
<div class="t-shirt-type" id="t-shirt">
    <div class="container">
        <h3>Выберите вид чашки</h3>
    </div>
    <div class="tab_content singular">
        <div class="tab-item product-slider-2 product-swiper-element">
            <div class="swiper-container swiper-container-horicupsal">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/1.jpg" alt="">
                            </a>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/2.jpg" alt="">
                            </a>
                            <p class="product-name-big">
                                <a href="/chashki-pod-pechat.html">
                                    Ярко-синий
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/3.jpg" alt="">
                            </a>
                            <p class="product-name-big">
                                <a href="/chashki-pod-pechat.html">
                                    Красный
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/4.jpg" alt="">
                            </a>
                            <p class="product-name-big">
                                <a href="/chashki-pod-pechat.html">
                                    Коричневый
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/5.jpg" alt="">
                            </a>
                            <p class="product-name-big">
                                <a href="/chashki-pod-pechat.html">
                                   Темно-синий
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/6.jpg" alt="">
                            </a>
                            <p class="product-name-big">
                                <a href="/chashki-pod-pechat.html">
                                    Желтый
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <a href="/chashki-pod-pechat.html">
                                <img src="/images/tmp/landings/cups/7.jpg" alt="">
                            </a>
                            <p class="product-name-big">
                                <a href="/chashki-pod-pechat.html">
                                    Белый
...
<div class="brand-slider no-image" id="our-works">
    ...
    <div class="brand-swiper-element">
        ...
        <div class="swiper-container brand-wrapper swiper-container-horicupsal swiper-container-free-mode">
            <div class="swiper-wrapper">
                <div class="swiper-slide swiper-slide-prev">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/1.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/2.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/3.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-next">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/4.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/5.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/6.jpg" alt="">
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-active">
                    <div class="product-item">
                        <img src="/images/tmp/landings/cups/brand-slider/7.jpg" alt="">
                    </div>
                </div>
            </div>
