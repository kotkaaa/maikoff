 ...
 *
 * @author  Edi ModriД‡ <edi.modric@gmail.com>
...
(function ($) {
    ...
    $.fn.select2.locales['hr'] = {
        ...
        formatInputTooShort: function (input, min) { return "Unesite joЕЎ" + character(min - input.length); },
        formatInputTooLong: function (input, max) { return "Unesite" + character(input.length - max) + " manje"; },
        formatSelectionTooBig: function (limit) { return "Maksimalan broj odabranih stavki je " + limit; },
        formatLoadMore: function (pageNumber) { return "UДЌitavanje rezultataвЂ¦"; },
