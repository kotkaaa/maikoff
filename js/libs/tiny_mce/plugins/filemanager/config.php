<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../uploaded/media/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../uploaded/media/'; // absolute or relative from this script path.
