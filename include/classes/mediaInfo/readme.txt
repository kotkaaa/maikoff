...
* Support for RIFF-INFO chunks
  * http://lotto.st-andrews.ac.uk/~njh/tag_interchange.html
    (thanks Nick Humfrey <njhШsurgeradio*co*uk>)
...
* Support for ICO
* Support for ANI
* Support for EXE (comments, author, etc) (thanks p*quaedackersШplanet*nl)
* Support for DVD-IFO (region, subtitles, aspect ratio, etc)
  (thanks p*quaedackersШplanet*nl)
* More complete support for SWF - parsing encapsulated MP3 and/or JPEG content
    (thanks n8n8Шyahoo*com)
* Support for a2b
* Optional scan-through-frames for AVI verification
  (thanks rockcohenШmassive-interactive*nl)
* Support for TTF (thanks infoШbutterflyx*com)
...
* Support for ID4 (http://www.wackysoft.cjb.net grizlyY2KШhotmail*com)
* Parse XML data returned in Ogg comments
* Parse XML data from Quicktime SMIL metafiles (klausrathШmac*com)
