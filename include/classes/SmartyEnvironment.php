...
/**
 * Description of SmartyEnvironment class
 * @author WebLife
 * @copyright 2010
 * @version $Id: SmartyEnvironment.php 03 2011-09-28 13:38:40 $
 * @modified 2018-04-04 13:38:40 $
 */
class SmartyEnvironment extends Smarty {
   /**
     * Template name
     *
     * @var  string
   ...
   /**
     ...
     * @param   bool    $check_compile
     * @param   bool    $caching
     * @return  void
     */
    public function __construct($tplname, $debug=false, $error_reporting=null, $force_compile=1, $check_compile=0, $caching=0) {
        parent::__construct();
        ...
        $this->compile_check    = (bool)$check_compile;
...
//        $this->inheritance = true;
    ...
    public function setCompileCheck($compile_check) {
        parent::setCompileCheck((bool)$compile_check);
    }
    ...
    public function setCacheLifeTime($cache_lifetime) {
        parent::setCacheLifetime((int)$cache_lifetime);
    }
