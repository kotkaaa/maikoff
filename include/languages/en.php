...
define('ADMIN_CREATING_NEW_PRODUCT_TYPE', 'Creating new product type');
...
define('ADMIN_EDIT_PRODUCT_TYPE', 'Product type edit page');
...
define('NEWS', 'News');
define('PRINT_TYPES', 'Print types');
define('SIZE_GRIDS', 'Size tables');
define('VIDEOS', 'Video');
